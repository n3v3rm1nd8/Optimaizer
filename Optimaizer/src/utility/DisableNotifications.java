...
public class DisableNotifications {
    ...
    public void disable(){
        ...
        int rc = Advapi32.INSTANCE.RegOpenKeyEx(WinReg.HKEY_CURRENT_USER, "Software\\Microsoft\\Windows\\CurrentVersion\\PushNotifications",0, WinNT.KEY_SET_VALUE, hKey);
        ...
        if (rc == 0) {  // ERROR_SUCCESS = 0
            ...
            rc = Advapi32.INSTANCE.RegSetValueEx(hKey.getValue(), "ToastEnabled", 0, WinNT.REG_DWORD, valueRef.getPointer(), 4);
